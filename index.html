...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  body::before {
    ...
    position: fixed;
    inset: 0;
    background-image: url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctave[...]
    pointer-events: none;
    z-index: 1000;
    opacity: 0.4;
  }
  ...
  <div class="about-grid" style="grid-template-columns: 280px 1fr 1fr; gap: 3rem; align-items: start;">
    <div class="reveal" style="position:relative;">
      <div style="aspect-ratio:3/4; overflow:hidden; border:1px solid var(--border2); position:relative;">
        <img src="data:image/png;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/4gHYSUNDX1BST0ZJTEUAAQEAAAHIAAAAAAQwAABtbnRyUkdCIFhZWiAH4AABAAEAAAAAAABhY3NwAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAQAA9tYAAQAAAADTLQAA[...]
    ...
    <div class="reveal">
      <p class="about-text">
        Dedicated UI/UX Designer with a proven ability to translate complex user needs into <strong>intuitive and engaging digital experiences</strong>. Possesses a strong foundation in user-centered [...]
        <br><br>
        Eager to leverage collaborative skills and a keen eye for usability to drive impactful design solutions and enhance user satisfaction. Currently completing a <strong>Bachelor of Business Infor[...]
      </p>
    </div>
